...
int main()
{
	...
	Shader screenShader("shaders/screen_shader.vert", "shaders/screen_shader.frag");
    ...
    // load textures
    // -------------
    unsigned int cubeTexture = TextureUtils::loadTexture("container.jpg", "resources");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        screenShader.use();
		screenShader.setBool("isMirror", true);
        glBindVertexArray(quadVAO);
